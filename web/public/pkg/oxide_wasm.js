...
export class SimHandle {
     ...
     */
    fail_host(host_id) {
        wasm.simhandle_fail_host(this.__wbg_ptr, host_id);
    }
    /**
     * @param {number} count
     */
    inject_burst(count) {
        wasm.simhandle_inject_burst(this.__wbg_ptr, count);
    }
    constructor() {
        const ret = wasm.simhandle_new();
        this.__wbg_ptr = ret;
     ...
     * @param {number} host_id
     */
    recover_host(host_id) {
        wasm.simhandle_recover_host(this.__wbg_ptr, host_id);
    }
    /**
     * @returns {any}
     */
    snapshot() {
        const ret = wasm.simhandle_snapshot(this.__wbg_ptr);
        if (ret[2]) {
    ...
    tick() {
        wasm.simhandle_tick(this.__wbg_ptr);
    }
}
...
const SimHandleFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_simhandle_free(ptr, 1));
